...
export const KEYWORD_POOL = [
  ...
  { q: '접이식 블루투스 키보드 휴대용', keyword: '태블릿펜' },
  ...
  { q: 'AI 녹음기 요약', keyword: '콘덴서마이크' },
  { q: '스마트 태그 분실방지 애플 찾기', keyword: '펫트래커' },
