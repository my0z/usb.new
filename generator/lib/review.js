...
불합격 사유 (확실한 것만):
- 제품 정보나 참고 자료(리뷰 발췌)에 근거가 없는 구체적 수치나 기능을 사실처럼 단정함. 참고 자료에 있는 사실은 근거가 있는 것이다. 검색어는 제품 사실이 아니다 (검색어가 카드형이어도 제품명에 없으면 카드형이라고 쓰면 안 된다). 예: 배터리 시간 · 무게 · 용량 · 정확도 · 방수 등급 · 앱 연동 · 구성품 · 재질
