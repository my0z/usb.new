...
export const mockArticleJson = JSON.stringify({
  ...
  verdict: '얇은 맥세이프 보조배터리를 찾는다면 첫 후보로 둘 만합니다.',
  fit: ['아이폰을 케이블 없이 충전하고 싶은 사람', '가방보다 주머니에 넣고 다니는 사람'],
  unfit: ['노트북까지 충전하려는 사람'],
  pros: ['10000mAh 로 하루치 용량', '자석으로 붙여 케이블이 필요 없다', '로켓배송'],
  cons: ['무선 충전 속도는 유선보다 느리다', '케이스 두께에 따라 자석이 약해질 수 있다 (확인 필요)'],
  specs: [{ k: '용량', v: '10000mAh' }, { k: '가격', v: '39,900원' }, { k: '배송', v: '로켓배송' }],
  tips: ['가격은 게재 시점 기준이니 쿠팡에서 다시 확인', '맥세이프 케이스가 아니면 링을 따로 붙인다'],
